...
namespace eShop.ProductAPI.Repository
{
    public class CategoryRepository : ICategoryRepository
    {
        ...
        {
            return await _context.Categories.Where(c => c.CategoryId == id).SingleOrDefaultAsync();
        }

        public async Task<Category> GetByName(string name)
        {
            return await _context.Categories.Where(c => c.Name == name).SingleOrDefaultAsync();
        }
